...
from recommender.ranking_model      import generate_ranking_model_rank, train_ranking_models_if_needed
    ...
    def run(self):
        ...
        while True:
            ...
            if mode == self.Recommender.COLD_START:
                ...
                self.last_linear_model_train_seen = train_ranking_models_if_needed(
                    df=self.df,
                    user_profile=self.user_profile,
                ...
                recommended_tracks = generate_ranking_model_rank(
                    df=self.df,
                    user_profile=self.user_profile,
                    seen_track_ids=self.user_profile.seen_song_ids,
                    n_songs=BATCH_SIZE,
